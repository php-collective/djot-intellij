...
Building, running, and the release/publishing process are documented in
[docs/development.md](docs/development.md). For contributing (setup, project
structure, grammar updates, testing), see [CONTRIBUTING.md](CONTRIBUTING.md).
